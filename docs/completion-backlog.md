...
- [x] **`ignore_changes`/`replace_triggered_by`/`depends_on` lists offer no attribute/address completion** (medium, effort M, confidence high) — crates/tfls-lsp/src/handlers/completion.rs:1419-1430; crates/tfls-core/src/completion.rs:573 (expression_context)
