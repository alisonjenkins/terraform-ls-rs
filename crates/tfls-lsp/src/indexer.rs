...
pub use tfls_engine::index::{
    index_module_dir_sync, install_builtin_provider_schema,
    rebuild_assigned_variable_types_for_dir, rebuild_unknown_module_vars_for_dir,
};
...
mod tests {
    ...
    //! client-side I/O.
    use super::{
        decide_refresh, ensure_module_indexed, handle_disk_removal,
